            ...
            ${state.activeView === 'dashboard' 
                ? `<div class="action-group">
                       <select id="auto-trigger-interval" style="background: var(--surface); color: var(--text-main); border: 1px solid var(--border-color); border-radius: 4px; padding: 2px 4px; font-size: 0.7rem; cursor: pointer;" title="Auto-trigger Rescan Interval">
                           <option value="Off" style="background: var(--surface); color: var(--text-main);" ${state.config.settings.autoTriggerInterval === 'Off' ? 'selected' : ''}>Off</option>
                           <option value="1m" style="background: var(--surface); color: var(--text-main);" ${state.config.settings.autoTriggerInterval === '1m' ? 'selected' : ''}>1m</option>
                           <option value="5m" style="background: var(--surface); color: var(--text-main);" ${state.config.settings.autoTriggerInterval === '5m' ? 'selected' : ''}>5m</option>
                           <option value="1h" style="background: var(--surface); color: var(--text-main);" ${state.config.settings.autoTriggerInterval === '1h' ? 'selected' : ''}>1hr</option>
                       </select>
